...
export const TextInput = ({
  ...
  return (
    <div className="grid gap-1">
      <label
        htmlFor={name}
        className="font-black uppercase tracking-wide text-slate-400"
      >
        {title}
      </label>
      <input
        ...
        } rounded px-3 py-1 border focus:border-blue-400 outline-0 w-full placeholder:text-slate-300`}
      />
...
export const File = ({ register, type, title, name, error, placeholder }) => {
  return (
    <div className="grid gap-1">
      <label htmlFor={name} className="font-black uppercase tracking-wide">
        {title}
